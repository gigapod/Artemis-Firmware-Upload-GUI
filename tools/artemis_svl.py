...
#
# ***********************************************************************************
def phase_bootload(ser, binfile):
...
#
# ***********************************************************************************
def phase_serial_port_help( port ):
...
#
# ***********************************************************************************
def upload_firmware(binfile, port, baud, timeout=0.5):
    try:
        num_tries = 3
...
if __name__ == '__main__':
    ...
    upload_firmware(args.binfile, args.port, args.baud, args.timeout)
